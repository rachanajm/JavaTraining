         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-md-6 text-center mb-5">
                  <h2 class="heading-section">Hello Admin, login to your account.</h2>
               </div>
            </div>
            <div class="row justify-content-center">
               <div class="col-md-12 col-lg-10">
                  <div class="wrap d-md-flex">
                     ...
                     <div class="login-wrap p-4 p-lg-5">
                        ...
                        <form action="validateadmin.jsp" class="form" method="post" onsubmit="return validateData()">
                           ...
                           <div class="form-group">
                              ...
                              <input type="password" class="form-control" id="password" placeholder="Enter Admin Password" name="password" required>
                           </div>
                           <div class="form-group">
