...
<html>
    <head>
        ...
        <title>View Cancelled Orders of Customer</title>
      <style>
  body {
...
<body>
  ...
  <div class="container-fluid">
   ...
   <div class="navbar-header">
    ...
    <div class="site-blocks-cover inner-page" style="background-image: url('images/show9.jpg');">
            ...
            <table class="table table-striped table-hover table-bordered" id="table_id">
                ...
                <tbody>
                    ...
                    <% 
                            ...
                            List<Order> lst = dao.getAllOrderdetailsadmin();
                    ...
                    <tr>
                        ...
                        <td><%=qs.isCancelled()%></td>
                         ...
                         <td>
                            ...
                            <input class = "btn btn-danger" type="submit" value="Delete This Cancelled Order"/>
                            </form>
                        </td>  
